...
class OpenSSLTest extends \PHPUnit_Framework_TestCase
{
     ...
     */
    public function testCheckSignature($message, $publicKeyFile, $expectedResult)
    {
        $publicKeyFile = __DIR__ . '/../pubkey/' . $publicKeyFile;

        $openssl = new OpenSSL();
        $result = $openssl->checkSignature($message, $publicKeyFile);
    ...
    public function providerCheckSignature()
    {
        return [
            ...
            ['IdSession=1448876207&StatusPBX=Timeout&3DSTATUS=N&3DSIGNVAL=Y&3DENROLLED=Y&3DERROR=0&3DXID=ZeA3onBxBw9dkhCjS6rGv6f+Kd4=&ID3D=2000000273403&Check=Z1S5tq60WHzdGHfeDoIdkgaqpz614Zl1qnqQo4dHiaSHx4NW%2byk8iXOj1rJ1f1L7lvGU2DtsxPvgk34dKOHDg5fOkKZiGNgkN05L10VybvjlgfwE4ryDwnQA%2fDkM1DW1aZxyvloJLVwNwyRyZuFu1QeIICLUJoXflDOHXmrvtzw%3d', 'e-transactions.pem', true],
            ['IdSession=1448876207&StatusPBX=Timeout&3DSTATUS=N&3DSIGNVAL=Y&3DENROLLED=Y&3DERROR=0&3DXID=ZeA3onBxBw9dkhCjS6rGv6f+Kd4=&ID3D=2000000273403&Check=Z1S5tq60WHzdGHfeDoIdkgaqpz614Zl1qnqQo4dHiaSHx4NW%2byk8iXOj1rJ1f1L7lvGU2DtsxPvgk34dKOHDg5fOkKZiGNgkN05L10VybvjlgfwE4ryDwnQA%2fDkM1DW1aZxyvloJLVwNwyRyZuFu1QeIICLUJoXflDOHXmrvtza%3d', 'e-transactions.pem', false],
            ['IdSession=1448876207&StatusPBX=Timeout&3DSTATUS=N&3DSIGNVAL=Y&3DENROLLED=N&3DERROR=0&3DXID=ZeA3onBxBw9dkhCjS6rGv6f+Kd4=&ID3D=2000000273403&Check=Z1S5tq60WHzdGHfeDoIdkgaqpz614Zl1qnqQo4dHiaSHx4NW%2byk8iXOj1rJ1f1L7lvGU2DtsxPvgk34dKOHDg5fOkKZiGNgkN05L10VybvjlgfwE4ryDwnQA%2fDkM1DW1aZxyvloJLVwNwyRyZuFu1QeIICLUJoXflDOHXmrvtzw%3d', 'e-transactions.pem', false],
        ];
    }
}
